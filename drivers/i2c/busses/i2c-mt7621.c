			...
			int num)
{
	...
	for (i = 0; i < num; i++) {
		...
		/* start sequence; this becomes a repeated START for i > 0 */
	...
	/* The return value is the number of executed messages. */
	return num;
...
static int mtk_i2c_probe(struct platform_device *pdev)
{
	...
	if (!i2c->caps)
		return dev_err_probe(&pdev->dev, -EINVAL, "cannot get caps for i2c");
