...
#define EN751221_PPE_CACHE_CTL_CMD	GENMASK(13, 12)
...
#define REG_PPE_KEEPALIVE(_n)			(((_n) ? PPE2_BASE : PPE1_BASE) + 0x234)
...
#define REG_PPE_VPM_TPID(_n)			(((_n) ? PPE2_BASE : PPE1_BASE) + 0x318)
